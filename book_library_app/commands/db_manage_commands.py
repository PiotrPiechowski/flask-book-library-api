...
def db_manage():
    """Databases managment commands"""
    pass


@db_manage.command()
def add_data():
    """Add sample data to datebase"""
    try:
        ...
        db.session.commit()
        print('Data has been successfull added to database')
    except Exception as exc:
        print("Unexcepted error: {}".format(exc))
...
def remove_data():
    ...
    try:
        ...
        db.session.commit()
        print('Data has been successfull remove from database')
    except Exception as exc:
        print("Unexcepted error: {}".format(exc))
